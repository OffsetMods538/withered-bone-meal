...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    protected void generateRecipes(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapelessRecipeJsonBuilder.create(Items.BLACK_DYE, 4).input(ModItems.WITHERED_BONE_MEAL).group("black_dye").criterion("has_withered_bone_meal", conditionsFromItem(ModItems.WITHERED_BONE_MEAL)).offerTo(exporter, "black_dye_from_withered_bone_meal");
    }
}
